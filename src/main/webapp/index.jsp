		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link" href="CreateAndFind1">Lista
							de Clientes</a></li>
				</ul>
		...
		<div class="row">
			<div class="cold-md-7">
				...
				<form action="CreateAndFind1" method="POST">
					...
					<div class="form-floating mb-3">
						<input name="endereco" type="text" class="form-control"> <label>Endereço</label>
					</div>
					<select name="modalidade" class="form-select mb-3"
						aria-label="Default select example">
						<option value="CNPJ" selected>Selecione a modalidade</option>
				...
				<br>
				<h5>
					<a href="CreateAndFind1">Lista de Clientes</a>
				</h5>
			</div>
